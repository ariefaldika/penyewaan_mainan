    ...
    <div id="wrapper">
        ...
        <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <button class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModal">Tambah</button>
                            </div>
                            </div>
                            <br>
                            <!-- end table button -->
                            ...
                            <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>QR Code <span class="help"></span></label>
                                                <input type="text" class="form-control" placeholder="QR Code" name="qrcode" required> 
                                        </div>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary waves-effect" name="add">Tambah</button>
                                        </div>
                                        </form>
                                    </div>
                                    <!-- /.modal-content -->
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img width="75" src="../temp/<?php echo $nama ?>.png">
                                            </td>
                                            <td>
